get_notifications = {
    ...
    400: {
        ...
        "content": {
            "application/json": {"example": {"detail": "Notifications not found"}}
        },
    },
}
...
get_notification = {
    200: {
        ...
        "content": {
            "application/json": {
                "example": {"notification_id": 1, "message": "aaa", "user_id": 1}
            }
        },
    },
    400: {
...
update_notification = {
    200: {
        ...
        "content": {
            "application/json": {"example": {"notification_id": 1, "message": "bbb"}}
        },
    },
    400: {
        "description": "Any problem",
