get_episodes = {
    ...
    400: {
        ...
        "content": {"application/json": {"example": {"detail": "Episodes not found"}}},
    },
}
...
get_episode = {
    ...
    400: {
        ...
        "content": {"application/json": {"example": {"detail": "Episode not found"}}},
    },
}
...
update_episode = {
    200: {
        ...
        "content": {"application/json": {"example": {"episode_id": 1, "title": "bbb"}}},
    },
    400: {
        "description": "Any problem",
        "content": {"application/json": {"example": {"detail": "..."}}},
...
delete_episode = {
    200: {
        ...
        "content": {
            "application/json": {"example": {"message": "Episode deleted successfully"}}
        },
    },
    400: {
        "description": "Episode not found",
