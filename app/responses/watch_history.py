get_watch_historys = {
    ...
    400: {
        ...
        "content": {
            "application/json": {"example": {"detail": "Watch historys not found"}}
        },
    },
}
...
get_watch_history = {
    200: {
        ...
        "content": {
            "application/json": {
                "example": {"watch_history_id": 1, "user_id": 1, "content_id": 1}
            }
        },
    },
    400: {
        ...
        "content": {
            "application/json": {"example": {"detail": "Watch history not found"}}
        },
    },
}
...
update_watch_history = {
    200: {
        ...
        "content": {
            "application/json": {
                "example": {"watch_history_id": 1, "user_id": 1, "content_id": 2}
            }
        },
    },
    400: {
