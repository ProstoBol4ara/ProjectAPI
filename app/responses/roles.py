get_roles = {
    ...
    400: {
        ...
        "content": {"application/json": {"example": {"detail": "Roles not found"}}},
    },
}
...
get_role = {
    200: {
        ...
        "content": {
            "application/json": {"example": {"role_id": 1, "role_name": "aaa"}}
        },
    },
    400: {
...
update_role = {
    200: {
        ...
        "content": {
            "application/json": {
                "example": {"role_id": 1, "rolename": "aaa", "email": "aaa@aaa.com"}
            }
        },
    },
    400: {
...
delete_role = {
    200: {
        ...
        "content": {
            "application/json": {"example": {"message": "Role deleted successfully"}}
        },
    },
    400: {
        "description": "Role not found",
