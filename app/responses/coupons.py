get_coupons = {
    ...
    400: {
        ...
        "content": {"application/json": {"example": {"detail": "Coupons not found"}}},
    },
}
...
get_coupon = {
    ...
    400: {
        ...
        "content": {"application/json": {"example": {"detail": "Coupon not found"}}},
    },
}
...
delete_coupon = {
    200: {
        ...
        "content": {
            "application/json": {"example": {"message": "Coupon deleted successfully"}}
        },
    },
    400: {
        "description": "Coupon not found",
