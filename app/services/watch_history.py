...
class WatchHistoryService:
    ...
    async def get_watch_historys(self):
        ...
        return None if watch_historys is None else [{"watch_history_id": watch_history.watch_history_id, "user_id": watch_history.user_id, "content_id": watch_history.content_id} for watch_history in watch_historys]
    ...
    async def get_watch_history(self, watch_history_id: int):
        ...
        return None if watch_history is None else {"watch_history_id": watch_history.watch_history_id, "user_id": watch_history.user_id, "content_id": watch_history.content_id}
    ...
    async def update_watch_history(self, watch_history_id: int, user_id: int = None, content_id: int = None):
        watch_history = await self.watch_historys_repository.update_watch_history(watch_history_id=watch_history_id, user_id=user_id, content_id=content_id)
        return None if watch_history is None else {"watch_history_id": watch_history.watch_history_id, "user_id": watch_history.user_id, "content_id": watch_history.content_id}
