...
class ContentLanguagesService:
    ...
    async def update_content_language(self, content_language_id: int, content_id: int = None, language_id: int = None):
        ...
        return None if content_language is None else {"content_genre_id": content_genre.content_genre_id, "content_id": content_genre.content_id, "genres_id": content_genre.genres_id}
