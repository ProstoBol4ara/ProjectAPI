...
class PaymentMethodsService:
    ...
    async def get_payment_methods(self):
        ...
        return None if payment_methods is None else [{"payment_method_id": payment_method.payment_method_id, "user_id": payment_method.user_id, "method_type": payment_method.method_type} for payment_method in payment_methods]
    ...
    async def get_payment_method(self, payment_method_id: int):
        ...
        return None if payment_method is None else {"payment_method_id": payment_method.payment_method_id, "user_id": payment_method.user_id, "method_type": payment_method.method_type}
    ...
    async def create_payment_method(self, user_id: int, method_type: str, provider: str, account_number: str):
        ...
        return {"payment_method_id": new_payment_method.payment_method_id, "user_id": new_payment_method.user_id, "method_type": new_payment_method.method_type, "provider": new_payment_method.provider, "account_number": new_payment_method.account_number}
