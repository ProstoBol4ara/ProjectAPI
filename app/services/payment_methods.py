...
class PaymentMethodsService:
    ...
    async def create_payment_method(self, user_id: int, method_type: str, provider: str, account_number: str):
        ...
        return {"payment_method_id": payment_method.payment_method_id, "user_id": payment_method.user_id, "method_type": payment_method.method_type, "provider": payment_method.provider, "account_number": payment_method.account_number}
