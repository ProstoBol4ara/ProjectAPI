...
class CouponsService:
    ...
    async def get_coupon(self, coupon_id: int):
        ...
        return None if coupon is None else {"coupon_id": coupon.coupon_id, "code": coupon.code, "discount_percentage": coupon.discount_percentage, "valid_from": coupon.valid_from, "valid_until": coupon.valid_until}
