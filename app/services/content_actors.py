...
class ContentActorsService:
    ...
    async def create_content_actors(self, content_id: int, actor_id: int, role: str = None):
        new_content_actor = await self.content_actors_repository.create_content_actors(content_id=content_id, actor_id=actor_id, role=role)
    ...
    async def update_content_actors(self, content_actor_id: int, content_id: int = None, actor_id: int = None, role: str = None):
        content_actor = await self.content_actors_repository.update_content_actors(content_actor_id=content_actor_id, content_id=content_id, actor_id=actor_id, role=role)
