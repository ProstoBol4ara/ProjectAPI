...
@router.get('/{content_language_id}', response_model=dict)
...
@router.put('/{content_language_id}', response_model=dict)
...
@router.delete('/{content_language_id}', response_model=dict)
