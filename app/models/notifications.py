...
class Notifications(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["created_by"], ["users.user_id"], name="notifications_created_by_fkey"
        ),
        ForeignKeyConstraint(
            ["deleted_by"], ["users.user_id"], name="notifications_deleted_by_fkey"
        ),
        ForeignKeyConstraint(
            ["user_id"], ["users.user_id"], name="notifications_user_id_fkey"
        ),
    ...
    notification_date = mapped_column(
    ...
    users: Mapped[Optional["Users"]] = relationship(
        "Users", foreign_keys=[created_by], back_populates="notifications"
    )
    users_: Mapped[Optional["Users"]] = relationship(
        "Users", foreign_keys=[deleted_by], back_populates="notifications_"
    )
    user: Mapped[Optional["Users"]] = relationship(
        "Users", foreign_keys=[user_id], back_populates="notifications1"
    )
